...
export type NewWithdrawFee0Event = ([newWithdrawFee: ethers.BigNumber] & {newWithdrawFee: ethers.BigNumber})
...
export const events = {
  ...
  ,
  "FlashLoan(Uint8Array,uint8,uint256,uint256,uint256)": {
    topic: abi.getEventTopic("FlashLoan(Uint8Array,uint8,uint256,uint256,uint256)"),
    decode(data: EvmEvent): FlashLoan0Event {
      return decodeEvent("FlashLoan(Uint8Array,uint8,uint256,uint256,uint256)", data)
    }
  }
  ,
  "NewAdminFee(uint256)": {
  ...
  "NewWithdrawFee(uint256)": {
    ...
    decode(data: EvmEvent): NewWithdrawFee0Event {
      return decodeEvent("NewWithdrawFee(uint256)", data)
    }
  }
  ,
  ...
  ,
  "RemoveLiquidity(Uint8Array,uint256[],uint256)": {
    topic: abi.getEventTopic("RemoveLiquidity(Uint8Array,uint256[],uint256)"),
    decode(data: EvmEvent): RemoveLiquidity0Event {
      return decodeEvent("RemoveLiquidity(Uint8Array,uint256[],uint256)", data)
    }
  }
  ,
  "RemoveLiquidityImbalance(Uint8Array,uint256[],uint256[],uint256,uint256)": {
    topic: abi.getEventTopic("RemoveLiquidityImbalance(Uint8Array,uint256[],uint256[],uint256,uint256)"),
    decode(data: EvmEvent): RemoveLiquidityImbalance0Event {
      return decodeEvent("RemoveLiquidityImbalance(Uint8Array,uint256[],uint256[],uint256,uint256)", data)
    }
  }
  ,
  ...
  ,
  "TokenSwap(Uint8Array,uint256,uint256,uint128,uint128)": {
    topic: abi.getEventTopic("TokenSwap(Uint8Array,uint256,uint256,uint128,uint128)"),
    decode(data: EvmEvent): TokenSwap0Event {
      return decodeEvent("TokenSwap(Uint8Array,uint256,uint256,uint128,uint128)", data)
    }
  }
  ,
  "Unpaused(Uint8Array)": {
...
export class Contract  {
  ...
  async calculateCurrentWithdrawFee(user: string): Promise<ethers.BigNumber> {
    return this.call("calculateCurrentWithdrawFee", [user])
  }

  async calculateRemoveLiquidity(account: string, amount: ethers.BigNumber): Promise<Array<ethers.BigNumber>> {
    return this.call("calculateRemoveLiquidity", [account, amount])
  }

  async calculateRemoveLiquidityOneToken(account: string, tokenAmount: ethers.BigNumber, tokenIndex: number): Promise<ethers.BigNumber> {
    return this.call("calculateRemoveLiquidityOneToken", [account, tokenAmount, tokenIndex])
  }
  ...
  async calculateTokenAmount(account: string, amounts: Array<ethers.BigNumber>, deposit: boolean): Promise<ethers.BigNumber> {
    return this.call("calculateTokenAmount", [account, amounts, deposit])
  }
  ...
  async getDepositTimestamp(user: string): Promise<ethers.BigNumber> {
    return this.call("getDepositTimestamp", [user])
  }
  ...
  async getTokenIndex(tokenUint8Array: string): Promise<number> {
    return this.call("getTokenIndex", [tokenUint8Array])
  }
  ...
  async swapStorage(): Promise<([initialA: ethers.BigNumber, futureA: ethers.BigNumber, initialATime: ethers.BigNumber, futureATime: ethers.BigNumber, swapFee: ethers.BigNumber, adminFee: ethers.BigNumber, defaultWithdrawFee: ethers.BigNumber, lpToken: string] & {initialA: ethers.BigNumber, futureA: ethers.BigNumber, initialATime: ethers.BigNumber, futureATime: ethers.BigNumber, swapFee: ethers.BigNumber, adminFee: ethers.BigNumber, defaultWithdrawFee: ethers.BigNumber, lpToken: string})> {
