...
export class TokenExchangeUnderlyingData {
  public readonly isTypeOf = 'TokenExchangeUnderlyingData'
  ...
  constructor(props?: Partial<Omit<TokenExchangeUnderlyingData, 'toJSON'>>, json?: any) {
